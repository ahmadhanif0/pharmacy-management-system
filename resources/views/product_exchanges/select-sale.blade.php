...
@push('page-header')
	<div class="col-sm-7 col-auto">
		<h3 class="page-title">Select Sale to Exchange Product</h3>
		<ul class="breadcrumb">
	...
	<div class="container">
		...
		@if($sales->isEmpty())
			<div class="alert alert-info">
				No sales available for exchange.
			</div>
		@else
			<div class="card">
				<div class="card-body">
							...
							<tbody>
								@foreach($sales as $sale)
									<tr>
										...
										<td>
											<a href="{{ route('product_exchanges.create', $sale->id) }}"
												class="btn btn-sm btn-primary">Create Exchange</a>
										</td>
									</tr>
								@endforeach
							</tbody>
