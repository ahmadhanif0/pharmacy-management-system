...
@push('page-header')
	...
	<div class="col-sm-5 col">
		<a href="#add_categories" data-toggle="modal" class="btn btn-primary float-right mt-2" style="border:none;">Add
			Category</a>
	</div>
									...
									<tr>
										...
										<td class="text-center">
											<div class="actions">
												...
												<a data-id="{{$category->id}}" data-toggle="modal" href="javascript:void(0)"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="{{route('categories')}}">
						...
						<button type="submit" class="btn btn-primary btn-block" style="border:none">Save Changes</button>
					</form>
				</div>
			</div>
		</div>
